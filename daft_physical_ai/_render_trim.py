...
def _demo_cells(config: TrimDemoConfig) -> list[tuple[str, str]]:
    ...
    cells: list[tuple[str, str]] = [
        ...
        (
            "markdown",
            "## See the spread\n\nMotion-energy curves with the kept window shaded: "
            "the most-trimmed episode, the median, and the least. The flat stretches "
            "outside a window are the operator not yet doing anything; an "
            "already-clean episode keeps nearly everything.",
        ),
        ("code", _VIZ_CELL),
        (
            "markdown",
